...
class TestCaseGenerator:
    ...
    def create_test_method(
        interface, test_case_name, function_call, test_case_expected_stdout
    ):
    ...
    def create_test_suite(self, file_path, test_cases):
        ...
        for test_case in test_cases:
            ...
            for interface in self.interfaces:
                test_method = TestCaseGenerator.create_test_method(
                    interface, test_case_name, function_call, test_case_expected_stdout
                )
...
class TestRunner:
    ...
    def __init__(self, interface_types):
        ...
        self.interfaces = [
            InterfaceFactory.get_interface(interface_type)
    ...
    def create_project_test_suites(self, test_suites):
        ...
        for file_path, test_cases in test_suites:
            test_suite = self.test_suite_factory.create_test_suite(
